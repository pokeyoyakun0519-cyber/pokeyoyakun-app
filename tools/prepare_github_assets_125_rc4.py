...
ASSET_DIR = (
    PROJECT_ROOT / "release" / "github_assets" / "ver1.25.0-rc4"
)
SOURCES = (
    (
        PROJECT_ROOT
    ...
    (
        PROJECT_ROOT / "RELEASE_NOTES_Ver1.25.0_RC4.txt",
        "RELEASE_NOTES_Ver1.25.0_RC4.txt",
    ),
    (
        PROJECT_ROOT / "TESTER_README_Ver1.25.0_RC4.txt",
