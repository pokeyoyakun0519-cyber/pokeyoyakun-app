...
DIST_DIR = PROJECT_ROOT / "release" / "user_dist_nuitka_rc4"
BUILD_ROOT = Path(tempfile.gettempdir()) / "PokeyoyaKun_Nuitka_Ver1.25.0_RC4"
...
def build_target(name: str, script: Path) -> None:
    ...
    command = [
        ...
        "--file-version=1.25.0.4",
        "--product-version=1.25.0.4",
