...
BUILTIN_RETAIL_PLUGINS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "regions": ["全国"],
        "tcg": ["pokemon", "onepiece", "yugioh", "gundam", "union_arena", "dragon_ball_fusion_world", "duelmasters", "weiss", "mtg"],
        "application_method": "Web",
        "result_mode": "account_page",
        "enabled": True,
    },
    ...
    },
    {
        ...
        "regions": ["全国"],
        "tcg": ["pokemon", "onepiece", "yugioh", "gundam", "duelmasters", "weiss"],
    ...
    },
    {
        ...
        "regions": ["九州"],
        "tcg": ["pokemon", "onepiece", "gundam", "dragon_ball_fusion_world"],
    ...
    },
    {
        ...
        "regions": ["全国"],
        "tcg": ["pokemon", "onepiece", "yugioh", "gundam", "duelmasters", "weiss", "mtg"],
        "application_method": "Web",
        "result_mode": "account_page",
        "enabled": False,
    ...
    },
    {
        ...
        "name": "ホビーステーション",
        "mode": "dedicated",
        "index_url": "https://www.hbst.net/sitemap.rss",
        "regions": ["全国"],
        "tcg": [
            "pokemon",
            "onepiece",
    ...
    },
    {
        ...
        "name": "カードラボ",
        "mode": "dedicated",
        "index_url": "https://www.c-labo.jp/blog/",
    ...
    },
    {
        ...
        "regions": ["全国"],
        "tcg": ["onepiece", "gundam", "union_arena", "dragon_ball_fusion_world"],
        "application_method": "Web",
        "result_mode": "account_page",
        "enabled": True,
    },
    ...
    },
    {
        ...
        "name": "タカラトミーモール",
        "mode": "public_html",
        "index_url": "https://takaratomymall.jp/shop/c/cDM/",
        "regions": ["全国"],
        "tcg": ["duelmasters"],
        "application_method": "Web",
        "result_mode": "account_page",
    ...
    },
    {
        ...
        "name": "ブシロード オンラインストア",
        "mode": "public_html",
        "index_url": "https://bushiroad-store.com/collections/ws-tcg",
        "regions": ["全国"],
        "tcg": ["weiss"],
        "application_method": "Web",
        "result_mode": "account_page",
